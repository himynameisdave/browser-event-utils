export type EventType = Event & KeyboardEvent & { [index: string]: string }; // eslint-disable-line @typescript-eslint/no-type-alias
...
export type $TSFixMe = any; // eslint-disable-line @typescript-eslint/no-explicit-any,@typescript-eslint/no-type-alias
